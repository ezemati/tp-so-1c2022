...
void inicializar_proceso(int socket_cliente)
{
	...
	log_trace_with_mutex(logger, &mutex_logger, "Inicializando estructuras para proceso %d con tamanio %d", request->pid, request->tamanio_proceso);
...
void suspender_proceso(int socket_cliente)
{
	...
	log_info_with_mutex(logger, &mutex_logger, "Suspendiendo proceso %d cuya tabla 1N es %d", request->pid, request->numero_tablaprimernivel);
...
void finalizar_proceso(int socket_cliente)
{
	...
	log_info_with_mutex(logger, &mutex_logger, "Finalizando proceso %d cuya tabla 1N es %d", request->pid, request->numero_tablaprimernivel);
...
void leer_dato(int socket_cliente)
{
	...
	log_info_with_mutex(logger, &mutex_logger, "Leyendo %d bytes de la direccion fisica %d", request->cantidad_bytes, request->direccion_fisica);
...
void escribir_dato(int socket_cliente)
{
	...
	log_info_with_mutex(logger, &mutex_logger, "Escribiendo %d bytes en la direccion fisica %d", request->cantidad_bytes, request->direccion_fisica);
...
void obtener_numero_tabla_2_para_entrada_tabla_1(int socket_cliente)
{
	...
	log_trace_with_mutex(logger, &mutex_logger, "Buscando numero de tabla 2N para entrada %d de la tabla de 1N %d", request->entrada_tablaprimernivel, request->numero_tablaprimernivel);
	uint32_t numero_tablasegundonivel = memoria_ram_obtener_numero_tabla_2_para_entrada_tabla_1(memoria_ram, request);
	log_info_with_mutex(logger, &mutex_logger, "Numero de tabla 2N para entrada %d de la tabla de 1N %d = %d", request->entrada_tablaprimernivel, request->numero_tablaprimernivel, numero_tablasegundonivel);
...
void obtener_marco_para_entrada_tabla_2(int socket_cliente)
{
	...
	log_trace_with_mutex(logger, &mutex_logger, "Buscando numero de marco para entrada %d de la tabla de 2N %d", request->entrada_tablasegundonivel, request->numero_tablasegundonivel);
	...
	log_info_with_mutex(logger, &mutex_logger, "Numero de marco para entrada %d de la tabla de 2N %d = %d", request->entrada_tablasegundonivel, request->numero_tablasegundonivel, numero_marco);
