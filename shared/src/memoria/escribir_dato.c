...
{
    // PID (uint32), DIR_FISICA (uint32), CANT_BYTES (uint32), DATO (cant_bytes)
...
t_memoria_escribirdato_request *deserializar_escribirdato_request(void *buffer)
{
    ...
    t_memoria_escribirdato_request *request = escribirdato_request_new(pid, direccion_fisica, cantidad_bytes, dato);
