...
{
    estado_proceso estado_anterior = proceso_cambiar_estado(pcb, S_SUSPENDED_BLOCKED);

    log_info_with_mutex(logger, &mutex_logger, "Pasando proceso %d de %s a SUSPENDED_BLOCKED", pcb->id, estado_proceso_to_string(estado_anterior));
...
{
    estado_proceso estado_anterior = proceso_cambiar_estado(pcb, S_SUSPENDED_READY);

    log_info_with_mutex(logger, &mutex_logger, "Pasando proceso %d de %s a SUSPENDED_READY", pcb->id, estado_proceso_to_string(estado_anterior));
